  ...
  const games = [
    {
      ...
      description: 'Tebak kata bahasa Inggris dalam 6 kesempatan. Game klasik untuk melatih vocabulary!',
      icon: Grid3x3,
      difficulty: 'Medium',
      color: 'bg-green-500',
      players: '1,234'
    },
    {
      ...
      description: 'Teka-teki silang interaktif dengan clues dalam bahasa Inggris.',
      icon: Grid3x3,
      difficulty: 'Hard',
      color: 'bg-blue-500',
      players: '892'
    },
    {
      id: 'scramble',
      title: 'Word Scramble',
      description: 'Susun huruf acak menjadi kata yang benar. Cepat dan menyenangkan!',
      icon: Shuffle,
      difficulty: 'Easy',
      color: 'bg-purple-500',
      players: '2,156'
    },
    {
      id: 'hangman',
      title: 'Hangman',
      description: 'Tebak kata sebelum gambar tergantung lengkap. Game klasik yang seru!',
      icon: Skull,
      difficulty: 'Easy',
      color: 'bg-orange-500',
      players: '1,567'
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-xl text-gray-600">
            Belajar bahasa Inggris sambil bermain! Pilih game favoritmu dan tingkatkan vocabulary
          </p>
        </div>
          ...
          {games.map((game) => {
            ...
            return (
              <Card key={game.id} className="overflow-hidden hover:shadow-lg transition-all group">
                <div className={`${game.color} p-8 text-white relative overflow-hidden`}>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between mb-4 pb-4 border-b">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-600">{game.players} pemain aktif</span>
                    </div>
                  </div>
        ...
        <Card className="mt-12 p-8 max-w-3xl mx-auto bg-orange-100 border-primary/20">
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li>• Jangan takut mencoba - kesalahan adalah bagian dari proses belajar</li>
